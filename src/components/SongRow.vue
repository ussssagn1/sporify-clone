...
<template>
  <li class="flex items-center justify-between rounded-md hover:bg-[#2A2929]" @mouseleave="isHover = false" @mouseenter="isHover = true">
    <div class="flex items-center w-full py-1.5">
      <div v-if="isHover" class="w-[40px] ml;-[14px] mr-[6px] cursor-pointer">
        <Play v-if="true" fill-color="#FFFFFF" :size="25"></Play>
        <Pause v-else fill-color="#FFFFFF" :size="25"></Pause>
      </div>
